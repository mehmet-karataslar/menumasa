...
class UrlServiceIO extends UrlServiceBase {
  @override
  void updateUrl(String route, {String? customTitle, Map<String, String>? params}) {
    // No browser URL on mobile/desktop, just log for debugging
    if (customTitle != null) {
      print('Mobile/Desktop: Would set title to: $customTitle');
    }
    print('Mobile/Desktop: Would update URL to: $route');
  }
  ...
  void replaceUrl(String route, {String? customTitle, Map<String, String>? params}) {
    ...
    print('Mobile/Desktop: Would replace URL with: $route');
  }
  ...
  String getCurrentPath() {
    // Return default path for mobile/desktop platforms
    return '/';
  }
  ...
  Map<String, String?> parseBusinessUrl() {
    // Return default values for mobile/desktop platforms
  ...
  void setupUrlListener(Function(String) onUrlChange) {
    // No URL listener needed on mobile/desktop platforms
    print('Mobile/Desktop: URL listener setup not needed on this platform');
  }
  ...
  void navigateWithUrl(BuildContext context, String route, {
    ...
    // Update URL first (no-op on mobile/desktop)
    if (replace) {
